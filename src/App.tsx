...
interface Field { id: string; en: string; es: string; ar: string; fr: string; type: "text"|"date"|"select"|"textarea"|"yesno"|"note"|"question"; opts?: string[][]; tall?: boolean; req?: boolean; }
...
const SECTIONS: Section[] = [
  { id:"ai",
    ...
    fields:[
      ...
      {id:"entry_instruction",en:"19c. List each entry into the U.S. beginning with your most recent entry. List date (mm/dd/yyyy), place, and your status for each entry. (Attach additional sheets as needed.)",es:"19c. Liste cada entrada a EE.UU. comenzando con la más reciente. Liste la fecha (mm/dd/aaaa), lugar y su estatus para cada entrada. (Adjunte hojas adicionales según sea necesario.)",ar:"١٩ج. أدرج كل دخول إلى الولايات المتحدة بدءاً من الأحدث. أدرج التاريخ والمكان وحالتك لكل دخول. (أرفق أوراقاً إضافية حسب الحاجة.)",fr:"19c. Listez chaque entrée aux États-Unis en commençant par la plus récente. Indiquez la date (mm/jj/aaaa), le lieu et votre statut pour chaque entrée. (Joindre des feuilles supplémentaires si nécessaire.)",type:"question"},
  ...
  { id:"aiii",
    ...
    fields:[
      ...
      {id:"aiii_q2",en:"2. Provide the following information about your residences during the past 5 years. List your present address first. (NOTE: Use Form I-589 Supplement B, or additional sheets of paper, if necessary.)",es:"2. Proporcione la siguiente información sobre sus residencias durante los últimos 5 años. Liste su dirección actual primero. (NOTA: Use el Formulario I-589 Suplemento B, u hojas adicionales, si es necesario.)",ar:"٢. قدم المعلومات التالية عن مساكنك خلال السنوات الخمس الماضية. أدرج عنوانك الحالي أولاً. (ملاحظة: استخدم النموذج I-589 الملحق ب، أو أوراقاً إضافية، إذا لزم الأمر.)",fr:"2. Fournissez les informations suivantes sur vos résidences au cours des 5 dernières années. Listez votre adresse actuelle en premier. (NOTE: Utilisez le Formulaire I-589 Supplément B, ou des feuilles supplémentaires, si nécessaire.)",type:"question"},
      ...resRow(1),...resRow(2),...resRow(3),...resRow(4),...resRow(5),
      {id:"aiii_q3",en:"3. Provide the following information about your education, beginning with the most recent school that you attended. (NOTE: Use Form I-589 Supplement B, or additional sheets of paper, if necessary.)",es:"3. Proporcione la siguiente información sobre su educación, comenzando con la escuela más reciente que asistió. (NOTA: Use el Formulario I-589 Suplemento B, u hojas adicionales, si es necesario.)",ar:"٣. قدم المعلومات التالية عن تعليمك، بدءاً من أحدث مدرسة التحقت بها. (ملاحظة: استخدم النموذج I-589 الملحق ب، أو أوراقاً إضافية، إذا لزم الأمر.)",fr:"3. Fournissez les informations suivantes sur votre éducation, en commençant par l'école la plus récente que vous avez fréquentée. (NOTE: Utilisez le Formulaire I-589 Supplément B, ou des feuilles supplémentaires, si nécessaire.)",type:"question"},
      ...eduRow(1),...eduRow(2),...eduRow(3),...eduRow(4),
      {id:"aiii_q4",en:"4. Provide the following information about your employment during the past 5 years. List your present employment first. (NOTE: Use Form I-589 Supplement B, or additional sheets of paper, if necessary.)",es:"4. Proporcione la siguiente información sobre su empleo durante los últimos 5 años. Liste su empleo actual primero. (NOTA: Use el Formulario I-589 Suplemento B, u hojas adicionales, si es necesario.)",ar:"٤. قدم المعلومات التالية عن عملك خلال السنوات الخمس الماضية. أدرج وظيفتك الحالية أولاً. (ملاحظة: استخدم النموذج I-589 الملحق ب، أو أوراقاً إضافية، إذا لزم الأمر.)",fr:"4. Fournissez les informations suivantes sur votre emploi au cours des 5 dernières années. Listez votre emploi actuel en premier. (NOTE: Utilisez le Formulaire I-589 Supplément B, ou des feuilles supplémentaires, si nécessaire.)",type:"question"},
      ...empRow(1),...empRow(2),...empRow(3),
      {id:"aiii_q5",en:"5. Provide the following information about your parents and siblings (brothers and sisters). Check the box if the person is deceased. (NOTE: Use Form I-589 Supplement B, or additional sheets of paper, if necessary.)",es:"5. Proporcione la siguiente información sobre sus padres y hermanos/as. Marque la casilla si la persona ha fallecido. (NOTA: Use el Formulario I-589 Suplemento B, u hojas adicionales, si es necesario.)",ar:"٥. قدم المعلومات التالية عن والديك وأشقائك (إخوة وأخوات). ضع علامة في المربع إن كان الشخص قد توفي. (ملاحظة: استخدم النموذج I-589 الملحق ب، أو أوراقاً إضافية، إذا لزم الأمر.)",fr:"5. Fournissez les informations suivantes sur vos parents et frères/sœurs. Cochez la case si la personne est décédée. (NOTE: Utilisez le Formulaire I-589 Supplément B, ou des feuilles supplémentaires, si nécessaire.)",type:"question"},
  ...
  { id:"c",
    ...
    fields:[
      ...
      {id:"late_filing_detail",en:"5. If Yes — explain why you did not file within the first year after you arrived. You must be prepared to explain at your interview or hearing why you did not file your asylum application within the first year after you arrived. For guidance in answering this question, see Instructions, Part 1: Filing Instructions, Section V, Completing the Form, Part C.",es:"5. Si Si — explique por que no presento la solicitud dentro del primer ano despues de llegar. Debe estar preparado para explicar en su entrevista o audiencia por que no presento su solicitud de asilo dentro del primer ano. Para orientacion, consulte las Instrucciones, Parte 1, Seccion V, Completar el formulario, Parte C.",ar:"5. En neem — ashrah limatha lam tatakadam khilal alsana alula bad wusolak. Yajib an takoun mustaeddan liltoudioh fi muqabalatk aw jalsat alistimaa.",fr:"5. Si Oui — expliquez pourquoi vous n'avez pas depose dans la premiere annee apres votre arrivee. Vous devrez etre pret a expliquer lors de votre entretien ou audience pourquoi vous n'avez pas depose votre demande d'asile dans la premiere annee.",type:"textarea"},
      ...
      {id:"us_crimes_detail",en:"6. If Yes — for each instance, specify in your response: what occurred and the circumstances, dates, length of sentence received, location, the duration of the detention or imprisonment, reason(s) for the detention or conviction, any formal charges that were lodged against you or your relatives included in your application, and the reason(s) for release. Attach documents referring to these incidents, if they are available, or an explanation of why documents are not available.",es:"6. Si Si — para cada instancia, especifique: que ocurrio y las circunstancias, fechas, duracion de la sentencia, lugar, duracion de la detencion o encarcelamiento, razon de la detencion o condena, cargos formales, y razon de la liberacion. Adjunte documentos si estan disponibles, o una explicacion de por que no estan disponibles.",ar:"6. En neem — haded li kull halah: ma allathi hadath walzuraf, waltawarikh, wamuddat alhukm, walmawthi, wamuddat alihtijaz, wasabab alisdana, walittihamat alrasmiya, wasabab alefraj.",fr:"6. Si Oui — pour chaque instance, precisez: ce qui s'est passe et les circonstances, dates, duree de peine, lieu, duree de detention, raison de condamnation, charges formelles, et raison de liberation. Joignez les documents disponibles ou une explication de leur absence.",type:"textarea",tall:true},
    ]},
];
...
function FieldRow({field,lang,value,onValue,answeredIn,onAnsweredIn}: {
  ...
  if (field.type==="question") {
    return (
      <div style={{fontSize:13, fontWeight:600, color:C.text, lineHeight:1.6, marginBottom:10, direction:dir}}>
        {label}
      </div>
    );
  }
